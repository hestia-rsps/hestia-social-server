...
class FriendListRemoveHandler : PlayerMessageHandler<FriendListRemove>() {

    override fun handle(ctx: ChannelHandlerContext, player: Player, message: FriendListRemove) {
